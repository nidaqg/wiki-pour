...
const cocktailData = [
  {
    ...
    rating_average: 5,
    instructions:
      "Pour a quarter ounce simple syrup and two ounces whiskey in a rocks glass. Add two dashes of Angostura bitters, stir with a big cube and garnish with an orange peel",
    user_id: 1,
  },
  {
    ...
    rating_average: 4,
    instructions:
      "Pour one once each of Gin Campari and sweet vermouth into a stirring glass. Stir then strain into rocks glass. Garnish with orange peel",
    user_id: 2,
  },
  {
    ...
    rating_average: 4,
    instructions:
      "Add all the bourbon (or rye), sweet vermouth and both bitters to a mixing glass with ice, and stir until well-chilled. Strain into a chilled coupe. Garnish with a brandied cherry.",
    user_id: 2,
  },
  {
